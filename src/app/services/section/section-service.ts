...
export class SectionService {
  ...
  private readonly sections: SectionCard[] = [
    ...
    },
    {
      ...
      extraData: [
        { id: 1, title: 'Acme Platform', subtitle: 'Java, Maven, Spring Boot', description: 'A platform for students and teachers...', imgUrl: './assets/image/projects/acme.png', gitUrl: 'https://github.com/1337KR3W/DP2-G27-Acme' },
        { id: 2, title: 'Virtual Knowledge', subtitle: 'Angular, Material Design', description: 'Web app for managing user data using ReqRes API.', imgUrl: './assets/image/projects/virtual-knowledge.png', gitUrl: 'https://github.com/1337KR3W/Virtualknowledge-Frontend' },
        ...
        { id: 7, title: 'Netscanner', subtitle: 'Bash, Arp, Python', description: 'Tool to discover connected hosts via arp packets.', imgUrl: './assets/image/projects/netscanner.png', gitUrl: 'https://github.com/1337KR3W/netscanner' },
        { id: 8, title: 'Pynotech', subtitle: 'Python, PySide6', description: 'Notepad developed for my Bachelors Thesis.', imgUrl: './assets/image/projects/pynotech.png', gitUrl: 'https://github.com/1337KR3W/pyNotech' }
      ]
    },
    {
      id: 4,
